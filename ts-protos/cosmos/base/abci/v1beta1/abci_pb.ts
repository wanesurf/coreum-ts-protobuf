...
import type { Event } from "../../../../tendermint/abci/types_pb";
...
export const file_cosmos_base_abci_v1beta1_abci: GenFile = /*@__PURE__*/
  fileDesc("", [file_gogoproto_gogo, file_tendermint_abci_types, file_tendermint_types_block, file_google_protobuf_any]);
 ...
 */
export const TxResponseSchema: GenMessage<TxResponse> = /*@__PURE__*/
 ...
 */
export const ABCIMessageLogSchema: GenMessage<ABCIMessageLog> = /*@__PURE__*/
 ...
 */
export const StringEventSchema: GenMessage<StringEvent> = /*@__PURE__*/
 ...
 */
export const GasInfoSchema: GenMessage<GasInfo> = /*@__PURE__*/
 ...
 * @deprecated
 */
export const MsgDataSchema: GenMessage<MsgData> = /*@__PURE__*/
 ...
 */
export const TxMsgDataSchema: GenMessage<TxMsgData> = /*@__PURE__*/
 ...
 */
export const SearchTxsResultSchema: GenMessage<SearchTxsResult> = /*@__PURE__*/
 ...
 */
export type SearchBlocksResult = Message<"cosmos.base.abci.v1beta1.SearchBlocksResult"> & {
  /**
   * Count of all blocks
   *
...
/**
 * Describes the message cosmos.base.abci.v1beta1.SearchBlocksResult.
 * Use `create(SearchBlocksResultSchema)` to create a new message.
 */
export const SearchBlocksResultSchema: GenMessage<SearchBlocksResult> = /*@__PURE__*/
  messageDesc(file_cosmos_base_abci_v1beta1_abci, 10);
